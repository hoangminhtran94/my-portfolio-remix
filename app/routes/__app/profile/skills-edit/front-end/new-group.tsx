...
const FrontEndNewGroup = () => {
  ...
  const submitHandler = async (e: FormEvent) => {
    ...
    formdata.append("frontendgroups", JSON.stringify(selectedList));
...
export default FrontEndNewGroup;
...
export const action: ActionFunction = async ({ request }) => {
  ...
  const jsonData = formData.get("frontendgroups");
