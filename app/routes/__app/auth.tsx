    ...
    <div className="w-full flex justify-center self-center ">
      <div className="w-[80%] lg:w-[40%] bg-white p-10 rounded-lg drop-shadow-lg">
        <p className="text-center text-3xl flex gap-2 justify-center">
          ...
          <span ref={modalRef} className=" relative ">
            <svg
            ...
            {toggleDescriptionModal && (
              <span className="absolute text-sm w-[300px] p-3 text-justify left-full border bg-white border-indigo-300 rounded">
                This is panel is for me only to login and manage content of this
                website <br /> The authentication of this website is session
                based.
              </span>
            )}
          </span>
