...
interface ImageItemInputProps {
  ...
  onDeleteImage: MouseEventHandler<HTMLDivElement>;
}
...
const ImageItemInput: FC<ImageItemInputProps> = ({
  ...
  const [multiScreenImages, setMultiscreenImages] = useState<
    MultiScreenImage[]
  >(image.multiScreenImages ?? []);
  return (
    <div className="flex row gap-4 p-2 border border-indigo-300">
