...
const About = () => {
  ...
  return (
    <InviewWrapper
      ...
      id="about"
      mode="top-bottom"
      className=" text-white min-h-screen mt-[80px]  3xl:mt-0 items-center font-extrabold flex gap-4  "
      key={pathname}
    >
      <div className="flex flex-col 3xl:flex-row gap-14 items-center md:py-9">
        ...
        <div className="flex flex-1  flex-col gap-4 leading-relaxed">
          <motion.div
            ...
            className="text-[36px] md:text-[60px] text-slate drop-shadow-white-around-xs h-[160px]  sm:h-[120px] md:h-[200px] xl:h-auto  tracking-widest"
          >
          ...
          <motion.h3
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ delay: 1, duration: 0.5 }}
            className="text-[20px] leading-loose md:text-[30px] drop-shadow-white-around-xs  text-slate tracking-widest"
          ...
          <motion.h3
            ...
            className="text-[20px] leading-loose drop-shadow-white-around-xs  text-slate md:text-[30px] tracking-widest"
            dangerouslySetInnerHTML={{
